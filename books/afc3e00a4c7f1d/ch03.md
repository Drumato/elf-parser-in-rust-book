...
| :----------: | :----: | :---------: | :-----------------------------------------------------: |
| magic number |   0    |      4      |                 0x7f, 0x45, 0x4c, 0x46                  |
|  elf class   |   4    |      1      |                 32bit/64bit object file                 |
|   elf data   |   5    |      1      |                         lsb/msb                         |
|  elf osabi   |   7    |      1      |                  build target(OS/ABI)                   |
|    e_type    |   16   |      2      |            reloc objやcore dump等，file kind            |
|  e_machine   |   18   |      2      |            ArmやAMD64などtarget architecture            |
|   e_entry    |   24   |      8      | entry point address. 大抵startup routine symbol address |
|   e_phoff    |   32   |      8      |           program header tableのstart offset            |
|   e_shoff    |   40   |      8      |           section header tableのstart offset            |
|   e_phnum    |   56   |      2      |              program header tableのentry数              |
|   e_shnum    |   60   |      2      |              section header tableのentry数              |
...
本当はelf typeやe_machineもちゃんとenumにするべきなんですが，完全に力尽きました...  
(無料なので許してください)  
